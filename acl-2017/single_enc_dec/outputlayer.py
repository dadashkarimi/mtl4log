...
class OutputLayer(object):
  ...
  def write(self, h_t, attn_scores=None, mask=None):
    ...
    Args:
      ...
      mask: mask vector to exclude out-of-domain tokens before softmax takes place.
    """
    ...
    if attn_scores:
      ...
      return T.nnet.softmax(scores)[0]

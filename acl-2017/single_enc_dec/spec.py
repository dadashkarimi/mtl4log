...
class Spec(object):
  ...
  """
  def __init__(self, in_vocabulary, out_vocabulary, domain_vocabulary, out_vocabularies, lexicon, hidden_size,
    ...
    self.out_vocabularies = out_vocabularies
  ...
  def get_params(self):
    ...
    if not self.domain_vocabulary.fixed_embed:
      params+= self.domain_vocabulary.get_theano_params()
    return params

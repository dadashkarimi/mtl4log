...
class NeuralModel(object):
  ...
  def __init__(self, spec, distract_num=0, float_type=numpy.float64):
    ...
    self.out_vocabularies = spec.out_vocabularies
    self.domain_vocabulary = spec.domain_vocabulary
  ...
  def sgd_step(self, ex, eta, l2_reg, distractors=None):
    ...
    if distractors:
      ...
      info = self._backprop(ex.x_inds, ex.y_inds, ex.d_inds, eta, ex.y_in_x_inds, l2_reg)
    p_y_seq = info[0]
    objective = info[1]
